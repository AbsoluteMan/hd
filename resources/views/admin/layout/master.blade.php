...
<head>
    ...
    <link href="{{asset('node_modules/hdjs/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('node_modules/hdjs/css/font-awesome.min.css')}}"
          rel="stylesheet">
    <script>
        //HDJS组件需要的配置
        hdjs = {
            'base': '/hd/public/node_modules/hdjs',
